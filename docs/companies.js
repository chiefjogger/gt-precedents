  ...
  "companies": [
    {
      ...
      "ic_read": {
        ...
        "competitive_dynamics": "Structural gap was real (existing distributor inefficiency); Telio had no defensible advantage beyond first-mover. Captive consumer brand, captive retail estate, captive financing, and captive logistics were all absent. VinShop with bank-partner and Vingroup-era assets reached only ~8.5% penetration over five years; the category is owned by structural balance sheets, not by venture capital.",
        "learnability": "An IC could develop conviction on building a B2B distribution layer onto existing structural advantages. The Telio post-mortem confirms An IC could not develop conviction on backing a venture-funded standalone B2B distribution platform."
      },
      "logo_file": null,
      "lat": 21.03,
      "lng": 105.85,
    ...
    },
    {
      ...
      "tagline": "Captive corporate-backed Vietnamese GT play inside One Mount Group (Vingroup until Q1 2022, bank-partner-aligned thereafter). Plateaued at ~8.5% of 1.4m TAM; rebranded OneShop Oct 2025 with newly-added POS layer; OneShop now frames TAM as 5.2m small traders.",
      "founders": [
        ...
        {"name": "A former senior banker", "role": "CEO of One Mount Group from 1 Aug 2025", "prior": "Senior Vietnamese banking executive 2018-2025"}
      ],
      ...
      "rounds": [
        {"date": "Late 2019", "stage": "Parent equity (One Mount Group inception)", "amount_usd_m": 130, "lead": "Vingroup (51.22%) and bank-partner-aligned shareholders", "post_money_usd_m": null},
        ...
        {"date": "Q1 2022", "stage": "Shareholder restructuring", "amount_usd_m": null, "lead": "Vingroup divests 51.22%; bank-partner-aligned absorb", "post_money_usd_m": null}
      ],
      "experiments": [
        {"name": "a merchant working-capital pipe via the bank partner", "year": 2021, "what": "Tet 2021 launch of bank-underwritten working-capital lending integrated into the VinShop order book.", "outcome": "The genuine moat in the One Mount stack and the only piece that has compounded across the OneShop rebrand."},
      ...
      "pivots": [
        {"year": 2022, "from": "a dual shareholder structure (a property group and a bank)", "to": "a single bank-partner anchor", "trigger": "Vingroup retail/tech retreat", "outcome": "Resolved control tension; platform sits inside bank-partner-flavoured holdco from Q1 2022"},
        ...
        {"year": 2025, "from": "Vingroup operator lineage (Diu)", "to": "bank-partner operator lineage (Hung)", "trigger": "Strategic consolidation Aug 2025", "outcome": "One Mount under direct bank-partner operational lineage for the first time"},
      ...
      "operating_arc": "VinShop launched in October 2020 inside One Mount Distribution, the goods-trading sub-pillar of One Mount Group, with capital, leadership, brand, and the first 100,000 stores all corporate inputs from Vingroup and a bank partner. Through 2021 it added a bank-partner working-capital financing pipe (Tet 2021), expanded from 12 to 22 provinces, and signed FM Logistic for northern 3PL in 2022. By Q1 2022 it carried 100,000 stores in 22 provinces with ~2,000 SKUs and ~6,000 monthly merchant adds. Vingroup divested its 51.22% stake in Q1 2022; bank-partner-aligned shareholders absorbed it. The October 2023 retailer recognition ceremony surfaced a 45,000-active-monthly figure against the 100,000 cumulative-onboarded base. Penetration plateaued at ~8.5% of the 1.4m mom-and-pop TAM. Decree 70/2025 forced the platform to ship POS, e-invoicing, and voice ordering; OneShop relaunched late October 2025 with MM Mega Market as the wholesale rail and a re-stated 5.2m TAM. The August 2025 leadership rotation placed A former senior banker from a bank partner into the One Mount CEO seat.",
      "voice": [
      ...
      "ic_read": {
        ...
        "product_truth": "Delivered B2B order capture, working-capital financing via a bank partner, and 24-province coverage at peak. Did not deliver closed-loop POS or unified consumer-merchant data layer for the entire 2020-2025 window. The OneShop rebrand is a five-years-late admission that the original product missed POS, voice ordering, and e-invoicing. Decree 70 (June 2025) is what forced the upgrade.",
        ...
        "competitive_dynamics": "The the partner-bank financing pipe is the genuine moat. integrated-FMCG structural advantage is asymmetrically present: an integrated modern-trade chain plus an integrated meat business plus an FMCG portfolio brand portfolio plus a banking partner. A new entrant could compete with OneShop on the distribution rail, ride alongside (e.g., an FMCG portfolio SKUs through OneShop), or build independent shop POS rails through an integrated modern-trade chain.",
        "learnability": "An IC could develop conviction on building shop POS that VinShop did not, leveraging modern-trade point-of-sale data and an integrated meat business cold chain with a banking partner other than the existing partner. Could not develop conviction on a clone-of-VinShop standalone B2B FMCG platform; the corporate-funded incumbent has run that play for five years and has not exited."
      },
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "competitive_dynamics": "Cold-chain infrastructure plus chain-customer base is the structural advantage. integrated-FMCG asymmetric advantage available: an integrated meat business (cold chain at scale, slaughterhouses), an FMCG portfolio (FMCG brand portfolio overlapping foodservice procurement), an integrated modern-trade chain (modern-trade footprint overlapping institutional buyers). Most-direct mapping of a Vietnamese FMCG group infrastructure to a cohort playbook.",
        "learnability": "An IC could develop high-confidence conviction. Customer mix closer to an integrated modern-trade muscle than to Telio's mom-and-pop muscle. Capital discipline ($15m over seven years) closer to an integrated group's M&A multiples. Strategic shareholder syndicate (Sumitomo, Mitsubishi UFJ, SMBC, CPF, Reazon) is a coherent buy-side counterparty pattern. Operator-founder profile (Tanaka from Pizza 4P's COO) treated favourably."
      },
      "logo_file": null,
      "lat": 10.7769,
      "lng": 106.7009,
    ...
    },
    {
      ...
      "peak_revenue_usd_m": null,
      "merchants_peak": null,
      "tagline": "Vingroup loyalty card and digital wallet inside VinCommerce, Nov 2016 to Dec 2019. The closest historical precedent inside an integrated FMCG estate for a closed-loop GT/MT digitization play. ~7m users at 2019, ~12m at 2024 under OneU.",
      "founders": [
      ...
      "experiments": [
        ...
        {"name": "VinCommerce divest to a Vietnamese FMCG group", "year": 2019, "what": "3 December 2019: Vingroup and a Vietnamese FMCG group agreed share swap of VinCommerce and VinEco into a new merged company in exchange for a Vietnamese FMCG group equity. Largest Vietnamese M&A deal of 2009-2023 period.", "outcome": "Severed the supermarket POS feed from the loyalty card. From Dec 2019 the supermarket POS data sat inside a Vietnamese FMCG holdco; the loyalty card data sat inside Vingroup (later One Mount)."},
      ...
      "pivots": [
        {"year": 2019, "from": "Closed-loop loyalty inside Vingroup", "to": "Open loyalty severed from VinMart POS", "trigger": "VinCommerce sale to a Vietnamese FMCG group", "outcome": "Two estates never re-integrated the data flow"},
      ...
      "operating_arc": "VinID launched in November 2016 as Vingroup's group-wide loyalty card and digital wallet inside VinCommerce. Through 2017-2019 it built closed-loop transaction capture across VinMart, VinMart+, Vinpearl, VinFast, Vincom Retail, and Vinhomes; user base reached ~7m by 2019. The decisive event was the December 2019 Vingroup-a Vietnamese FMCG group transaction: VinCommerce and VinEco transferred to a Vietnamese FMCG group, while VinID itself stayed inside Vingroup (later moved into One Mount). From that date the supermarket POS feed went to a Vietnamese FMCG group and VinID lost first-party shopper-cohort signal at the supermarket. The wallet kept running at Vingroup-controlled merchants but lost the supermarket as primary use case. By 2024 user count reached ~12m. The September 2024 rebrand to OneU repositioned the asset as a generic lifestyle platform with 300+ partner brands. In May 2025 OneU discontinued VinID Pay entirely.",
      "voice": [
      ],
      "failure_mode": "The pre-2019 VinID stack had four properties no Vietnamese consumer franchise has put together since: closed-loop transaction capture inside an integrated retailer, a working e-wallet, a multi-property earn surface, and a first-party data feed for FMCG brands. The 2019 transfer broke the first three. VinMart became a a Vietnamese FMCG group asset; the Vingroup-a Vietnamese FMCG group partnership preserved customer benefits as a contractual courtesy but not as a single data asset. The wallet leg (VinID Pay) survived eight years inside an environment without the primary use case before being retired in May 2025.",
      "aftermath": "The VinID brand continues under One Mount as OneU. The VinID Pay wallet was discontinued in May 2025 with end-user balances reportedly migrated or refunded. The OneU consumer asset has been repositioned as a generic lifestyle platform with 300+ partner brands rather than a Vingroup-first-party closed-loop programme. The structural consequence for the 2026 a new entrant opportunity: an integrated modern-trade chain now owns the supermarket POS data feed that VinID lost in December 2019. a new entrant inherits the asset that VinShop tried and failed to access from outside; OneU has lost its connection to it. A wallet is not a precondition for the a new entrant opportunity; a card and a POS feed are.",
      "customer_voice": [],
      "ic_read": {
        "consumer_truth": "Vietnamese consumers used VinID at the modern-trade chain tills as a habit during the integrated period; the value proposition was points-cross-redemption across a multi-property estate. Once the property network contracted (VinPro electronics chain closed, Vinpearl restructured, Vincom Retail demerged), the earn-and-burn loop weakened structurally.",
        ...
        "equity_transferability": "Loyalty programme as defensive moat, not growth engine. Asset value sits in the data feed inside the supermarket POS, which now lives inside a Vietnamese FMCG holdco since December 2019.",
        "value_creation_sizing": "Standalone valuation never anchored. The relevant value question is the asset value of the supermarket POS feed inside an integrated modern-trade chain, which has been compounding inside a Vietnamese FMCG group since 2019. Not a venture-grade question.",
        "competitive_dynamics": "OneU competes with MoMo, ZaloPay, ShopeePay on the wallet side and with in-store loyalty on the supermarket side. The competitive position is structurally weakened by the 2019 split.",
        "learnability": "Direct lesson for any new entrant: treat modern-trade POS as the asset the broader Vietnamese ecosystem tried and failed to replicate. Telio never had it; VinShop never linked to it; OneU has lost its connection to it. an integrated FMCG group could have it. The 2019 transfer is the historical event that made the 2026 a new entrant opportunity possible."
      },
      "logo_file": null,
      "lat": 21.0285,
      "lng": 105.8542,
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "Four documented layoff waves and the eight-year time-and-money cost ($1.6bn cumulative equity, peak headcount 11,500) demonstrate that the kirana app thesis is not capital-light, not behaviorally aligned, and not a category a Vietnamese FMCG group should fund into without a WhatsApp-first interaction model wired to FMCG and credit P&L."
      },
      "logo_file": null,
      "lat": 12.9716,
      "lng": 77.5946,
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "Cleanest case in the cohort that 'kirana B2B platform' without deep balance sheet, WhatsApp-native UX, or strategic FMCG ownership of supply will not generate a venture-scale outcome. The structural lesson for any new entrant is that B2B platform plays inside a 1-3% margin distribution channel require either captive supply (which a Vietnamese FMCG group has via a modern-trade chain and an FMCG portfolio) or captive credit (which a Vietnamese FMCG group does not), and ideally both."
      },
      "logo_file": null,
      "lat": 12.9716,
      "lng": 77.5946,
    ...
    },
    {
      ...
      "ic_read": {
        "consumer_truth": "Kiranas will use a B2B platform if it ships sub-case orders, honors quoted prices, and lends working capital. The same three product features should be the the product spec for any new entrant.",
        ...
        "learnability": "The Jumbotail playbook (sub-case orders, full stack, embedded fintech, franchise overlay, disciplined raise) is the closest map to a a path for a new entrant inside Vietnam's GT cohort; the operating discipline of raising $263m over 10 years versus Udaan's $1.6bn over the same period is the clearest IC datapoint that capital-light kirana B2B is possible if and only if the company refuses to chase consumer-facing burn."
      },
      "logo_file": null,
      "lat": 12.9716,
      "lng": 77.5946,
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "A four-month B2C kill is the single best decision in the cohort and demonstrates that fresh-produce B2C is not venture-scalable in India. For a new entrant, fresh produce should sit inside a modern-trade chain's existing supply chain, not as a stand-alone venture, and any fresh-adjacent kirana B2B initiative should be wired to integrated meat and produce infrastructure rather than built as a Ninjacart-shaped marketplace."
      },
      "logo_file": null,
      "lat": 12.9716,
      "lng": 77.5946,
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "Cleanest example in the cohort of 'stalled rather than dead', a 12-year journey that produced an operating business rather than a venture-scale outcome. The IC lesson for a Vietnamese FMCG group: rural digital commerce in India was solved by smartphone penetration, not by an assisted-commerce intermediation layer; for any new entrant in Vietnam, this is direct evidence that any kirana / GT digitization strategy must be designed for an already-smartphone-penetrated user base, not designed to be the smartphone substitute."
      },
      "logo_file": null,
      "lat": 12.9716,
      "lng": 77.5946,
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "$470m cumulative spend, $200m strategic write-off, four salary deferrals, the largest non-Byju's tech write-off Reliance has booked. The lesson for a Vietnamese FMCG group: a hyperlocal logistics arm cannot subsidize a quick-commerce vertical out of consumer pricing, and a strategic partner with infinite balance sheet does not protect against per-order unit economics. a new entrant should not enter quick-commerce as a venture; if it enters at all, it should be as a wholly internal P&L absorbed inside a modern-trade chain."
      },
      "logo_file": "dunzo.svg",
      "lat": 12.9716,
      "lng": 77.5946,
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "Most well-capitalized strategic walked away from the B2B kirana opportunity within ~3 years. The IC lesson for a Vietnamese FMCG group: balance sheet plus brand is not sufficient to defeat the kirana's existing distributor relationship; a winning model needs WhatsApp-native UX, informal-credit-equivalent terms, and a strategic FMCG supply position. a Vietnamese FMCG group has the supply position via a modern-trade chain and an FMCG portfolio, which is the structural advantage Amazon lacked."
      },
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "The Jan 2022 reorganization, ~18 months after launch, is the cleanest signal in the cohort that even Walmart's brand and capital plus 12 years of Best Price physical proof did not produce standalone wholesale economics. For a Vietnamese FMCG group, the IC lesson is that a kirana B2B initiative inside a larger group should run as an absorbed P&L from day one, with no expectation of standalone unit economics; absorption is the most realistic outcome path for a integrated-FMCG-shaped initiative."
      },
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "Most informative datapoint is the silent narrative walk-back through 2024-2025. Reliance announced millions of digitized kiranas, ramped to 300,000+, and then narrowed the program to a Metro-anchored B2B operation while pivoting strategic energy toward direct retail and consumer channels. For a new entrant, this argues for narrow product-market fit (selected merchants, selected categories, integrated into a modern-trade chain and an F&B chain footprints) rather than a millions-of-merchants ambition that requires capital a Vietnamese FMCG group does not have."
      },
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "equity_transferability": "Playbook does not transfer to a Vietnamese FMCG group because a Vietnamese FMCG group does not need to build a ledger app; the modern-trade plus telco merchant funnel already gives the merchant funnel.",
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "For a Vietnamese FMCG group, the lesson is the cost of pivot velocity. A captive parent must commit to one wedge for at least 24 months and instrument retention before adding the second product. Lummo's four pivots in four years is the empirical ceiling of how often even Sequoia, Tiger and CapitalG can be persuaded to keep funding before the cliff."
      },
      "logo_file": null,
      "lat": -6.2088,
      "lng": 106.8456,
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "equity_transferability": "Hardware-first model only pencils when the parent has a captive distribution capex motivation (i.e., owns the brands and uses kiosks for visibility and routing), not as a standalone venture. This is structurally relevant to a Vietnamese FMCG group, which has that captive motivation through an FMCG portfolio.",
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "equity_transferability": "Playbook does not transfer to a Vietnamese FMCG group because a Vietnamese FMCG group owns the brand portfolio and distribution muscle that GudangAda had to rent.",
        ...
        "learnability": "Buyback at marked-down preference shares is the cleanest possible signal that the thesis is dead. The single founder's pivot to beauty is a credible category move (beauty 30-50% gross margin) but a different business from warung digitization. For a Vietnamese FMCG group, GudangAda is not a model; it is a counter-model. If a Vietnamese FMCG group wants to monetize the GT layer, do so through brand activation, lending fees through a regulated partner, or own-distribution capex, not on the wholesale spread."
      },
      "logo_file": null,
      "lat": -6.2088,
      "lng": 106.8456,
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "equity_transferability": "Inventory-plus-credit playbook does not transfer to a captive FMCG conglomerate context unless the parent already has the working capital and brand portfolio (which a Vietnamese FMCG group does, through an FMCG portfolio and an integrated meat business).",
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "equity_transferability": "Playbook does not transfer to a Vietnamese FMCG group at integrated FMCG scale, but it is a template for how an FMCG group could run a small, focused F&B services unit (e.g., wrapping micro-eateries that already buy an FMCG portfolio SKUs) without burning capital.",
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "The lane matters more than the technology. Pick the lane where Bukalapak, Tokopedia, Tiki, Shopee and Lazada have low coverage; build matching physical infrastructure; take origination fees on credit through a regulated partner; avoid subsidising customer acquisition. For a Vietnamese FMCG group, the analogous lane is exactly Tier-3 and Tier-4 districts in Vietnam where the modern-trade footprint thins and the GT layer is dense. The template most worth studying."
      },
      "logo_file": null,
      "lat": -7.7956,
      "lng": 110.3695,
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "equity_transferability": "The warung programme survives because it sits on top of an existing customer-side marketplace; CAC was zero. an analogous Vietnamese case is modern-trade footprint plus Reddi/MoMo cross-base.",
    ...
    },
    {
      ...
      "ic_read": {
        ...
        "learnability": "Warung programmes work when they are layered on top of an existing two-sided platform that already does customer-side acquisition. They do not work as standalone ventures. Even super-app parents cannot run them at standalone profit; the path was to fold under TikTok Shop. For a Vietnamese FMCG group, this maps directly onto an integrated modern-trade chain + MoMo + an FMCG portfolio + an F&B chain: a captive ecosystem can support a warung programme that no standalone venture-backed peer can. Caveat: do not expect the GT layer to stand alone profitably without the full ecosystem stack."
      },
